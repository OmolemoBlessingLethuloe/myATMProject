...
{
    public abstract class MyATMProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyATMProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyATMProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyATMProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyATMProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyATMProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyATMProjectDbContext, Task<T>> func)
        {
            T result;
